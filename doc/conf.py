# -*- coding: utf-8 -*-
#
# Sphinx Morpho Theme documentation build configuration file.
#
...
htmlhelp_basename = 'sphinx_morpho_themedoc'
...
latex_documents = [
    (
        'index', 'sphinx_morpho_theme.tex',
        'Sphinx Morpho Theme Documentation',
